...
if(isset($_POST['submit'])){
    ...
    $action =       "Entered Expense Item";


    //checking if the member already exists
    $check_account = mysqli_query($con,"select * from expensesitems where item = '$item' and cat_id='$cat' and farm_id ='$farm' ");
    if(mysqli_num_rows($check_account) > 0){
        // $message = "<div class=\"alert alert-danger\"><strong>The Record Already Exists</strong></div>";
        echo "<script>alert('The Record Already Exists');</script>";
    } else{
        $sql_user = "insert into expensesitems(farm_id,item,cat_id,status)VALUES ('$farm','$item','$cat','Activated')";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Manage Expenses Items</h3>
                        <form action="manage-expense-items" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Expense Item</label>
                                        <div class="input-group">
                                            <input type="text" name="item" required autocomplete="off" class="form-control" id="exampleInputEmail1" placeholder="Expense Item">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="cat" required autocomplete="off" class="form-control" id="exampleInputEmail1" placeholder="Category">
                                            <div class="input-group-addon"><i class="ti-pencil-alt"></i></div>
                                        </div>
                                    </div>
