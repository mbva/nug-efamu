            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Spraying Records</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <table id="example23" class="myTable table table-responsive color-table info-table display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <th><?php
                                        ...
                                        ?>ID</th>
                                    <th>Date</th>
                                    <th>Frequency of Spraying</th>
                                    <th>Accaricide Used</th>
                                    <th>Action</th>
                                    <th>Action</th>
                                ...
                                if(isset($_POST['submit'])) {
                                    ...
                                    $select = mysqli_query($con, "select * from spraying where date_of_spraying BETWEEN '$date_from' AND '$date_to' and farm_id ='$farm'");
                                }
                                else{
                                    $current_month = date("m");
                                    $select = mysqli_query($con,"select * from spraying where  MONTH (date_of_spraying)= '$current_month' and farm_id ='$farm'");
                                }
                                $sno = 0;
                                while($results = mysqli_fetch_array($select)){
                                    ...
                                    <tr><input type="hidden" id="id" name="id" value="<?=$results['animal_id'];?>">
                                        <td><?=$sno;?></td>
                                        <td><?=$results['date_of_spraying'];?></td>
                                        <td><?=$results['frequency_of_spraying'];?></td>
                                        <td><?=$results['accaricide'];?></td>
                                        <td><a  style="color: white" class="btn btn-info"  href="edit-spraying?farm_id=<?=$results['farm_id'];?>&&id=<?=$results['id'];?>"><i class="fa fa-edit fa-1x"></a></i></td>
