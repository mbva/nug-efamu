            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-4"> <h3 class="box-title m-b-0">User Permissions</h3></div>
                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <div class="login-btn-inner">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <button style="float: right" name="save" class="btn btn-sm btn-primary login-submit-cs" type="submit">Search</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="table-responsive">
                            <table id="example23" class="myTable table table-responsive color-table success-table display nowrap table table-hover table-bordered" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th>S/No.</th>
                                    <th>Module Name</th>
                            ...
                            ?>
                            <h3 style="color:red">NO USER SELECTED</h3>
                            <?php
                        }
                        ?>
