                                    ...
                                    <tr><input type="hidden" id="id" name="id" value="<?=$results['id'];?>">
                                        ...
                                        <td><?=$results['status'];?>
                                            ...
                                            if($results['status']=="Activated"){
                                                ?>
                                                <a href="settings-process?memberid=<?= $results['id'];?>&&action=<?= "deactivate-doctor";?>&&subject=<?= $results['vet_name'];?>"  class="btn btn-danger" style="float: right"><i class="fa fa-power-off"></i></a>
                                                <?php
                                                $message = "Success";
                                            }
                                            if($results['status']=="Deactivated"){
                                                ?>
                                                <a href="settings-process?memberid=<?= $results['id'];?>&&action=<?= "activate-doctor";?>&&subject=<?= $results['vet_name'];?>"  class="btn btn-success" style="float: right"><i class="fa fa-toggle-on"></i></a>
                                                <?php
                                                $message = "Success";
                                            }
                                            ?>
