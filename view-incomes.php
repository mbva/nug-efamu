            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Income  Records</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-4"> <h3 class="box-title m-b-0">Income Records</h3></div>
                            <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="myTable table table-responsive color-table info-table display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                                ...
                                include 'db.php';
                                    ...
                                    $select = mysqli_query($con,"select * from incomes where date_recieved>= '$date_from' AND date_recieved<='$date_to' and farm_id ='$farm'");
                                } else{
                                    $current_month = date("m");
                                    //$current_month = 10;
                                    $select = mysqli_query($con,"select * from incomes where MONTH (date_recieved) ='$current_month' and farm_id ='$farm'");
                                }
                                $sno = 0;
                                $totalamount=0;
