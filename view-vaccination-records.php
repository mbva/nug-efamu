            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-4"> <h3 class="box-title m-b-0">Vaccination Records</h3></div>
                            <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="myTable table table-responsive color-table info-table display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    $select = mysqli_query($con,"select a.*,v.* from animal_registration a, vaccination v where v.date_of_vaccination BETWEEN '$date_from' AND '$date_to' and a.farm_id ='$farm' and v.farm_id ='$farm' and a.animal_id=v.animal_id");
                                    $sno = 0;
                                }
                                else{
                                    $current_month = date("m");
                                    //$current_month = 10;
                                    $select = mysqli_query($con,"select a.*,v.* from animal_registration a,vaccination v where MONTH (v.date_of_vaccination)='$current_month' and a.farm_id ='$farm' and v.farm_id ='$farm' and a.animal_id=v.animal_id");
                                }
                                if(!$select){
                                ...
                                while($results = mysqli_fetch_array($select)){
                                    ...
                                    <tr><input type="hidden" id="id" name="id" value="<?=$results['animal_id'];?>">
                                        <td><?=$sno;?></td>
                                        <td><?=$results['date_of_vaccination'];?></td>
                                        <td><?=$results['tagNo'];?></td>
