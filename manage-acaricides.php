...
if(isset($_POST['submit'])){
    ...
    $action =       "Added an Acaricide";

    //checking if the member already exists
    $check_account = mysqli_query($con,"select * from manage_acaricide where acaricide_name = '$aname' and farm_id ='$farm'");
    if(mysqli_num_rows($check_account) > 0){
        // $message = "<div class=\"alert alert-danger\"><strong>Failed! The Acaricide already exists</strong></div>";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Manage Acaricides</h3>
                        <form action="manage-acaricides" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Name of the Acaricide</label>
                                        <div class="input-group">
                                            <input type="text" name="aname" required autocomplete="off" class="form-control" id="exampleInputEmail1" placeholder="Acaricide Name">
                                            <div class="input-group-addon"><i class="ti-pencil-alt"></i></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Acaricide Brand</label>
                                        <div class="input-group">
