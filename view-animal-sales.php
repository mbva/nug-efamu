            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Animal Sales Records</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-4"> <h3 class="box-title m-b-0">Animal Sales Records</h3></div>
                            <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="myTable table table-responsive color-table info-table display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    $select = mysqli_query($con,"select a.*,d.* from animal_registration a, animalsales d where d.solddate BETWEEN '$date_from' AND '$date_to'  and a.animal_id=d.animal_id");
                                }else{
                                    $current_month = date("m");

                                    $select = mysqli_query($con,"select a.*,d.* from animal_registration a, animalsales d where MONTH(d.solddate)='$current_month'  and a.animal_id=d.animal_id");
                                }
                                $sno = 0;
                                while($results = mysqli_fetch_array($select)){
                                    ...
                                    <tr><input type="hidden" id="id" name="id" value="<?=$results['animal_id'];?>">
                                        <td><?=$sno;?></td>
                                        <td><input type="text" id="fname" name="tagno" value="<?=$results['tagNo'];?>"></td>
                                        <td><input type="text" id="fname" name="aname" value="<?=$results['animal_name'];?>"></td>
                                        <td><input type="text" id="fname" name="gender" value="<?=$results['soldby'];?>"></td>
                                        <td><input type="text" id="fname" name="gender" value="<?=$results['solddate'];?>"></td>
                                        <td><input type="text" id="fname" name="gender" value="<?= "Shs ".number_format($results['sp']);?>"></td>
                                        <?php if($updaten==1){?>
                                            <td><a  style="color: white" class="btn btn-success" href="edit_animalsales?animalid=<?=$results['animal_id'];?>&&farm_id=<?=$results['farm_id'];?>"><i class="fa fa-edit fa-1x"></a></i></td>
                                        <?php }if($deleten==1){?>
