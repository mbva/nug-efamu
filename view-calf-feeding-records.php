            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Feeding Records</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-4"> <h3 class="box-title m-b-0">Calf Feeding Records</h3></div>
                            <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="myTable table table-responsive color-table info-table display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th>Date</th>
                                    <th>TagNo</th>
                                    <th>Colostrum Given</th>
                                    <th>Milk Given</th>
                                    <th>Supplement Given</th>
                                    <th>Recorded by</th>
                                    <th>Action</th>
                                    <th>Action</th>
                                </tr>
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    $select = mysqli_query($con,"select * from calf_feeding  where fdate >= '$date_from' AND fdate <='$date_to' and farm_id ='$farm' ");
                                }else{
                                    $current_month = date("m");
                                    //$current_month = 10;
                                    $select = mysqli_query($con,"select * from calf_feeding where MONTH (fdate)='$current_month' and farm_id ='$farm' ");
                                }
                                $sno = 0;
                                while($results = mysqli_fetch_array($select)){
                                    ...
                                    <tr><input type="hidden" id="id" name="id" value="<?=$results['animal_id'];?>">
                                        <td><?=$sno;?></td>
                                        <td><?=$results['fdate'];?></td>
                                        <td><?=$results['animal_id'];?></td>
                                        <td><?=$results['colostrumgiven'];?></td>
                                        <td><?=$results['milkgiven'];?></td>
                                        <td><?=$results['supplementgiven'];?></td>
                                        <td><?=$results['recby'];?></td>
                                        <td><a  style="color: white" class="btn btn-info"  href="edit-calf-feeding?animal_id=<?=$results['animal_id'];?>&&id=<?=$results['id'];?>"><i class="fa fa-edit fa-1x"></a></i></td>
