            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-4"> <h3 class="box-title m-b-0">Animal Feeding Records</h3></div>
                            <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example23" class="myTable table table-responsive color-table info-table display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                                ...
                                if(isset($_POST['submit'])) {
                                    ...
                                    $select = mysqli_query($con, "select * from animal_feeding where fdate >= '$date_from' AND fdate <= '$date_to' and farm_id ='$farm'");
                                }else{
                                    $current_month = date("m");
                                    //$current_month = 10;
                                    $select = mysqli_query($con,"select * from animal_feeding where MONTH (fdate)='$current_month' and farm_id ='$farm' ");
                                }
                                $sno = 0;
                                while($results = mysqli_fetch_array($select)){
                                    ...
                                    <tr><input type="hidden" id="id" name="id" value="<?=$results['animal_id'];?>">
                                        <td><?=$sno;?></td>
                                        <td><?=$results['fdate'];?></td>
                                        <td><?=$results['animalclass'];?></td>
                                        <td><?=$results['feedtype'];?></td>
                                        <td><?=$results['quantityfed'];?></td>
                                        <td><?=$results['frequency'];?></td>
                                        <td><?=($results['quantityfed']*$results['frequency']);?></td>
                                        <td><?=$results['numberofanimals'];?></td>
                                        <td><?=$results['recby'];?></td>
                                        <td><a  style="color: white" class="btn btn-info"  href="edit-animal-records?id=<?=$results['id']?>"><i class="fa fa-edit fa-1x"></a></i></td>
