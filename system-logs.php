        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
					<div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">System Logs Table</h3>
							 <div class="row">
...
?>ID</th>
	...
	$farm=$_POST['farm'];
									...
									$select = mysqli_query($con,"select * from login_logs where login_time BETWEEN '$date_from' AND '$date_to'  ");	
									
									}
									else {
										$current_month = date("m");
										$select = mysqli_query($con, "select * from login_logs where MONTH(login_time)='$current_month' ");
									}
									$sno = 0;
                                    while($results = mysqli_fetch_array($select)) {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?=$sno;?></td>
                                                <td><?=$results['username'].$today;?></td>
                                                
												<td><?=$selected_farm['farmname'];?></td>
                                                <td><?=$results['login_time'];?></td>
                                                <td><?=$results['login_action'];?></td>
