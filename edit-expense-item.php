...
<?php
$id = $_GET['id'];
$details = mysqli_fetch_array(mysqli_query($con,"select * from expensesitems where id='$id'"));
?>
</head>
<?php
include 'db.php';
...
if(isset($_POST['submit'])){
 ...
 $action =       "Edited Expense Item";

        $update = mysqli_query($con,"update expensesitems set item='$item', cat_id='$cat' where id='$id'");
...
?>
<script>window.location="view-expenses-items";</script>
<?php 
}
?>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="basic-login-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    ...
                                                    <input type="text" name="item" value="<?=$details['item']; ?>" required autocomplete="off" class="form-control" />
                                                    <input type="hidden" name="id" value="<?=$details['id']; ?>" required autocomplete="off" class="form-control" />
                                                </div>
                                                <div class="form-group-inner">
                                                    <label>Category</label>
                                                    <input type="text" name="cat" value="<?=$details['cat_id'];?>"  required autocomplete="off" class="form-control"/>
                                                </div>
